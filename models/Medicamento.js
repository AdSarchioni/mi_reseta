...
WHERE
    ...
    update: (id_med, id_reg_nac, nombre_generico, nombre_comercial, alta_med, id_concen, id_for_fa, id_fam, id_present, callback) => {
       
        const sql = `UPDATE medicamentos SET id_reg_nac, nombre_generico, nombre_comercial, alta_med, id_concen, id_for_fa, id_fam, id_present = ?  WHERE id_fam = ${id_med}`;
        conexion.query(sql, [id_reg_nac, nombre_generico, nombre_comercial, alta_med, id_concen, id_for_fa, id_fam, id_present], callback);
    },
    delete: (id, callback) => {
    ...
    alta: (id, callback) => {
        const sql = 'UPDATE familia SET alta_med = 1 WHERE id_med = ?';
        conexion.query(sql, [id], callback);
    }
};
